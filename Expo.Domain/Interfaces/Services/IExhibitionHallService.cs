...
public interface IExhibitionHallService
{
    ...
    /// <returns></returns>
    Task<Result<IList<ExhibitionHallOutDto>>> GetAllAsync(string baseUrl);
    /// <summary>
    /// Get an entity by id
    /// </summary>
    ...
    /// <param name="baseUrl">Controller base url</param>
    /// <returns></returns>
    Task<Result<ExhibitionHallOutDto>> GetByIdAsync(int id, string baseUrl);
    /// <summary>
    /// Create a new Entity
    /// </summary>
    ...
    /// <param name="baseUrl">Controller base url</param>
    /// <returns></returns>
    Task<Result<ExhibitionHallOutDto>> CreateAsync(ExhibitionHallInDto dto, string baseUrl);
    /// <summary>
    ...
    /// <param name="baseUrl">Controller base url</param>
    /// <returns></returns>
    Task<Result<ExhibitionHallOutDto>> UpdateAsync(int id, ExhibitionHallInDto dto, string baseUrl);
    /// <summary>
